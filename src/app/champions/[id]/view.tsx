...
import { MatchupsTab } from "@/components/matchups";
  ...
  return (
    <AppShell publicPage>
      ...
      <div className="mt-6">
        ...
        {tab === "matchups" && <MatchupsTab champion={{ id: champion.id, name: champion.name }} />}

        {tab === "coach" && (
          <CoachChat
            className="max-w-3xl"
            suggestions={[
              `What's the standard ${champion.name} build this patch, and when do I change it?`,
